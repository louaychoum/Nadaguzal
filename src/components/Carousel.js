...
import img1 from "../assets/GoldenEye.png";
import img2 from "../assets/goldEyes.png";
import img3 from "../assets/closeupEye.png";
  ...
  return (
    <Container>
      ...
      >
        <SwiperSlide>
          {" "}
          <img width={500} height={400} src={img1} alt="lens" />{" "}
        </SwiperSlide>
        <SwiperSlide>
          {" "}
          <img width={500} height={400} src={img2} alt="lens" />{" "}
        </SwiperSlide>
        <SwiperSlide>
          {" "}
          <img width={500} height={400} src={img3} alt="lens" />{" "}
        </SwiperSlide>
